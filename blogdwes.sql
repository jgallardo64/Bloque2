...
CREATE TABLE `usuarios` (
  ...
  `avatarGrande` varchar(100) NOT NULL,
...
--
ALTER TABLE `entradas`
  MODIFY `idEntrada` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
